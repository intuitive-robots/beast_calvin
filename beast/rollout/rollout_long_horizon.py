...
from beast.evaluation.multistep_sequences import get_sequences
from beast.evaluation.utils import get_env_state_for_initial_condition, join_vis_lang, LangEmbeddings
from beast.rollout.rollout_video import RolloutVideo
    ...
    def on_validation_start(self, trainer: Trainer, pl_module: LightningModule) -> None:
        ...
        if self.env is None:
            ...
            try:
                ...
                from beast.rollout.rollout import Rollout
