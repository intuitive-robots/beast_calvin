...
from beast.datasets.base_dataset import get_validation_window_size
from beast.rollout.rollout_video import RolloutVideo
from beast.utils.utils import get_portion_of_batch_ids
...
class Rollout(Callback):
    ...
    def on_validation_start(self, trainer: Trainer, pl_module: LightningModule) -> None:
        ...
        if self.env is None:
            ...
            from beast.rollout.rollout_long_horizon import RolloutLongHorizon
